...
public class KeyboardVisibilityEvent {
    ...
    public static Unregistrar registerEventListener(final Activity activity,
        ...
        final ViewTreeObserver.OnGlobalLayoutListener layoutListener =
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    private final int visibleThreshold = Math.round(
                            Utils.dpToPx(KEYBOARD_VISIBLE_THRESHOLD_DP, activity));
        ...
        return new Unregister(activity, layoutListener);
    }
    ...
    public static boolean isKeyboardVisible(Activity activity) {
        ...
        int visibleThreshold =
                Math.round(Utils.dpToPx(KEYBOARD_VISIBLE_THRESHOLD_DP, activity));
